...
- NodeJS version 20 ขึ้นไป - (แนะนำให้ติดตั้ง NodeJS ผ่าน version manager อย่างเช่น `nvm`)
...
ใน task นี้เราจะต้องสร้าง API Gateway Server ที่ทำหน้าคอย**รวบรวมข้อมูลจาก data server ที่ถูกจัดเตรียมไว้ให้** (จะมีการกล่าวถึง data server ในหัวข้อถัดไป)

**API Gateway สามารถเลือกใช้ ภาษา, framework และ tools ได้ตามความถนัด**

#### Requirements

- [ ] สร้าง endpoint ต่าง ๆ และส่งข้อมูลกลับไปให้ web สามารถแสดงผลตามดีไซน์ที่กำหนดไว้ได้อย่างถูกต้อง โดยต้องคำนึงถึงข้อผิดพลาดต่างๆ ที่อาจจะเกิดขึ้นได้
...
สร้าง web application ที่เชื่อมต่อกับ API Gateway สำหรับแสดงผลลายแทงร้านอาหาร **โดยคำนึงถึง UX และ UI ที่ดีต่อผู้ใช้งาน** ทำให้ผุ้ใช้งานรู้สึกได้ว่าการใช้งาน web ของเรานั้นสะดวกสบายและรวดเร็วยิ่งกว่าการใช้วิธีค้นหาโดยตรงจาก search engine
